...
contains
        ...
        integer :: arr_length, dim, sub_dim, i, j, j_shift, k, sub_dim_counter = 0, sub_dim_shift, dim_shift, dim_counter
        ...
        do k = 1, dim 
            ...
            do i = 1, sub_dim
                ...
                do j = 1, sub_dim
                    ...
                    write(*,"(I2, ': 'I2)") j + sub_dim_shift, mod(j,sub_dim) + 1  + sub_dim_shift 
...
program legrangian
    use functions
    implicit none
    integer, parameter ::  dim = 3, sub_dim = 3, arr_length = sub_dim ** dim !dim (e.g. n x n for dim = 2, n x n x n...), sub_dim = n, length of array = dim ^ sub_dim
    ...
    write(*,*) "Random Array:"
    do i = 1, arr_length
       write(*,"(I2, ': ', F20.4)") i, arr(i)

    end do

    lagrangian_value = lagrangian_equation(arr, arr_length, dim, sub_dim)

    write(*, "('Total Legrangian: ' F9.6)") lagrangian_value
